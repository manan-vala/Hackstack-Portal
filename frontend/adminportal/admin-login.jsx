...
import { adminLogin, mockAdminLogin } from "../../api/admin";
    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Hackstack Admin</h1>
        ...
        {USE_MOCK && (
          <p className="text-center text-xs text-gray-600 mt-4">
            Mock mode: use <span className="text-gray-400">admin / hackstack123</span>
          </p>
        )}
      </motion.div>
    </div>
